	...
	static class AppServicesBuilder
	{
		internal static ServiceProvider BuildServiceProvider(ITopLevelVisualProvider topLevelVisualProvider)
		{
			IServiceCollection services = new ServiceCollection()
				...
				.AddTransient<IUiDocumentService>(ServiceProviderServiceExtensions.GetRequiredService<DockFactory>)
				.AddTransient<IUiWindowService>(ServiceProviderServiceExtensions.GetRequiredService<DockFactory>)
