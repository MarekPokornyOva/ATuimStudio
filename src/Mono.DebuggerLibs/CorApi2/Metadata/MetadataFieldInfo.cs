...
namespace Microsoft.Samples.Debugging.CorMetadata
{
    ...
    {
        internal MetadataFieldInfo(IMetaDataImport importer,mdFieldDef fieldToken, MetadataType declaringType)
        {
            m_importer = importer;
        ...
        private mdFieldDef m_fieldToken;
