...
namespace Microsoft.Samples.Debugging.CorMetadata
{
	public class MetadataPropertyInfo: PropertyInfo
	{
		...
		private mdProperty m_propertyToken;
		...
		mdMethodDef m_pmdSetter;
		mdMethodDef m_pmdGetter;

		MetadataMethodInfo m_setter;
		MetadataMethodInfo m_getter;

		internal MetadataPropertyInfo (IMetaDataImport importer, mdProperty propertyToken, MetadataType declaringType)
		{
			m_importer = importer;
