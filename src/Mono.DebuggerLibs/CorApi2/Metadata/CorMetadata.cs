...
namespace Microsoft.Samples.Debugging.CorMetadata
{
    public sealed class CorMetadataImport
    {
        ...
        public int CountGenericParams(int typeToken)
        {
            ...
            mdGenericParam[] dummy = [];
            int dummy2;
            IntPtr hEnum = IntPtr.Zero;
            int count;
            importer2.EnumGenericParams(ref hEnum, typeToken, dummy, 1, out dummy2);
            try
            {
        ...
        {
            mdTypeDef token = CorMetadataImport.TokenNotFound;
            if( name.Length==0 )
        ...
        public string GetTypeNameFromDef(int token,out mdToken extendsToken)
        {
            int size;
        ...
        public string GetMemberRefName(int token)
        {
            ...
            case CorTokenType.mdtTypeDef: 
                {           
                    className = GetTypeNameFromDef(classToken,out _);
                    break;
                }
            }
    ...
    {
        internal MetadataMethodInfo(IMetaDataImport importer, mdMethodDef methodToken, Instantiation instantiation)
        {
            /*
            IsValidToken always return false -> commenting out
        ...
        public override System.Reflection.ParameterInfo[] GetParameters()
        {
            ...
            try 
            {
                ...
                {
                    int count;
                    mdParamDef[] paramToken = [new mdParamDef()];
        ...
        private mdTypeDef m_classToken;
        private mdMethodDef m_methodToken;
...
/*        internal static uint CorSigUncompressElementType(// return number of bytes of that compressed data occupied in pData
        ...
        {          
            ...
            try{
                int i=0;
                mdGenericParam[] genTypeToken = [new mdGenericParam()];
                do{
                    int nOut;
