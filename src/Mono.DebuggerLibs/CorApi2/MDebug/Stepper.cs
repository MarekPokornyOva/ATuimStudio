...
namespace Microsoft.Samples.Debugging.CorDebug
{
    ...
    {
        internal CorStepper (CorDebugStepper stepper)
            :base(stepper)
        {
            m_step = stepper;
        }
        ...
        {
            m_step.StepRange (stepInto, stepRanges, stepRanges.Length);
        }
        ...
        {            
				m_step.SetJMC(isJustMyCode);
        }

        private CorDebugStepper m_step;
    } /* class Stepper */
} /* namespace */
