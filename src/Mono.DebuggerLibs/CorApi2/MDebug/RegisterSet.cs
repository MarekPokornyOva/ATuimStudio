...
namespace Microsoft.Samples.Debugging.CorDebug
{
    ...
    {
        internal CorRegisterSet (CorDebugRegisterSet registerSet)
            :base(registerSet)
        {
            m_rs = registerSet;
        }
        ...
        {
            m_rs.GetThreadContext( contextSize, contextPtr );
        }

        public void SetThreadContext ( IntPtr contextPtr, int contextSize )
        {
            m_rs.SetThreadContext( contextSize, contextPtr );
        }

        private CorDebugRegisterSet m_rs;
    }
}
